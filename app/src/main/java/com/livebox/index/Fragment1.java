...
public class Fragment1 extends Fragment {
    ...
    private int page =1;
    private RecyclerViewAdapter recyclerViewAdapter=new RecyclerViewAdapter(MyApplication.getContext());
...
//        上拉加载
    ...
    void initData(boolean isMore,int page){
        ...
        map.put("aid","androidhd1");
        map.put("client_sys", "android");
        map.put("limit","20");
        map.put("offset", String.valueOf(page*10));
        map.put("time", String.valueOf(System.currentTimeMillis()/1000));
        RetrofitManager retrofitManager = new RetrofitManager(BaseUrl.Myservice);
        Call<ResponseBody> call = retrofitManager.crratereq(indexService.class).getIndexDate(map);
